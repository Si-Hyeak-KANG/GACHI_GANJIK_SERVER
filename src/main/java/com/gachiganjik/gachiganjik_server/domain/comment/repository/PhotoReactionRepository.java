...
public interface PhotoReactionRepository extends JpaRepository<PhotoReaction, Long> {
    ...
    Optional<PhotoReaction> findByPhotoAndGuestInfoAndReactionType(
            Photo photo, GuestInfo guestInfo, ReactionType reactionType);
    ...
    boolean existsByPhotoPhotoIdAndGuestInfoGuestIdAndReactionType(
            Long photoId, Long guestId, ReactionType reactionType);
}